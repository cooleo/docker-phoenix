...
RUN cp $PHOENIX_HOME/phoenix-core-4.7.0-HBase-1.1.jar $HBASE_HOME/lib/phoenix.jar
RUN cp $PHOENIX_HOME/phoenix-server-4.7.0-HBase-1.1.jar $HBASE_HOME/lib/phoenix-server.jar
